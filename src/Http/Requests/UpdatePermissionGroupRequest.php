...
#[OA\Schema(
    schema: 'UpdatePermissionGroupRequest',
    title: 'Update Permission Group Request',
    description: 'Data for updating a permission group',
    required: ['name'],
    properties: [
...
class UpdatePermissionGroupRequest extends FormRequest
{
    ...
    {
        return [
            'name' => 'required|string|max:255|unique:permission_groups,name,'.$this->route('permission_group')->id,
        ];
    }
}
